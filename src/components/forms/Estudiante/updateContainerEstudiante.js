...
class UpdateContainerEstudiante extends Component{
  constructor(){
    super();
    this.state = {
        form: {
    ...
    handleChange = e => {
      ...
      handleSubmit = async e => {
        ...
        //  estudiante.pais="Guatemala";
         const res=await axios.put("http://localhost:3001/actualizarEstudiante",estudiante);
    ...
    render(){
        ...
        return(
            <FormEstudiante handleSubmit={this.handleSubmit} handleChange={this.handleChange} form={this.state.form} titulo="Actualizar Estudiante" boton="Actualizar"/>
        )

    }
}
export default UpdateContainerEstudiante;